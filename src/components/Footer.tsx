    ...
    <footer className="bg-primary text-primary-foreground mt-24">
      <div className="container mx-auto px-6 py-12">
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-primary-foreground/80">
              <a href="tel:520-476-2292" className="flex items-center gap-2 hover:text-primary-foreground transition-colors">
                <Phone className="w-4 h-4" />
                520-476-2292
              </a>
              <a href="mailto:diamondcanyonpainting@gmail.com" className="flex items-center gap-2 hover:text-primary-foreground transition-colors">
          ...
          <div>
            <h4 className="text-sm font-semibold mb-4 uppercase tracking-wider">Hours</h4>
        ...
        <div className="mt-12 pt-8 border-t border-primary-foreground/20 text-center text-sm text-primary-foreground/60">
          <p>&copy; {new Date().getFullYear()} Diamond Canyon Painting. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
